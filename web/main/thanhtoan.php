      ...
      <form action="/action_page.php">
        ...
        <div class="row2">
          <div class="col-50">
            ...
            <input type="text" id="email" name="email" placeholder="dat@example.com">
            <label for="adr"><i class="fa fa-address-card-o"></i> Địa chỉ</label>
            <input type="text" id="adr" name="address" placeholder="Haui">
            <label for="city"><i class="fa fa-institution"></i> Tỉnh</label>
            <input type="text" id="city" name="city" placeholder="Thanh Hóa">

            <div class="row2">
              <div class="col-50">
                <label for="state">Thành Phố</label>
                <input type="text" id="state" name="state" placeholder="Thanh Hóa">
              </div>
              <div class="col-50">
                <label for="zip">Zip</label>
                <input type="text" id="zip" name="zip" placeholder="18052000">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="Trinh Viết Đạt">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="cvv" name="cvv" placeholder="18052000">
              </div>
            </div>
          </div>
